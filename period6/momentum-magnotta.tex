...
\begin{document}
\linenumbers
\title{Crashing Cars and Conserving Energy }
\author{Robert A. Magnotta}
\email{rmagnotta\_25@mbs.net}
...
\begin{abstract}
\student{After several days conducting research and the experiment, we collected 80 sets of data. We did this to prevent an experimental error and we crashed cars together. We also found that energy is conserved in an elastic collision. Although some energy was lost we figured out that it was a very small amount of energy lost, which ranged from 0.2171\%-0.2.955\%. 
}
\end{abstract}
\maketitle
...
\section{Discussion}
\student{In order to make sure that there were fair tests conducted we changed the weight of the two or more cars and took the data. The cars also collided on a track to make sure that it could be easily measured. The average joules lost in the collision was between 0.0131-0.0234. This is not very many proving that energy is conserved.}

\student{Some of the limitations that we had were not having an airtight area to conduct the experiment. This could have easily affected the data. We could not fit a lot of weight on the cars as well. If we were at a university we would have been able to use better cars to collect better data.}


\section{Acknowledgements}
We thank \student{A.~DeKuyper, S.~Cherins}, C.~Payette, J.~Bartholomew, B.~Turner, K.~Mauger, and S.~McCormick for useful advice and comments on the manuscript, and A.~Hahn, S.~Kealy, K~Muttick, and A.~Sankar, for advice on the design of experiment and learning objectives. Major lab equipment was gifted by the Alumni Association at Morristown-Beard School. This work was funded by ONR \#N123456789, AFOSR, NIH, and the National Science Foundation. 
