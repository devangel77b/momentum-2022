...
\section{Discussion}
\student{\Fref{fig:results2} shows the change in energy was \qty{-0.01\pm0.02}{\joule}. Even though there was a change in energy, it wasn’t a vast change and was not significantly different from \qty{0}{\joule}. After testing this multiple times, we can conclude that the energy is conserved since it is relatively close to zero.}  

\student{We came across many experimental errors during this process. Since the cars wouldn’t always stay on the track, we needed to test it multiple times from different people. There was also trouble when measuring the change in energy at times.} 
