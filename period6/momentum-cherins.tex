...
\begin{document}
\linenumbers
\title{Is energy conserved during Elastic Collision?}
\author{Sam Cherins}
\email{scherins\_25@mbs.net}
...
\section{Discussion}
\student{Energy is conserved because the Joules only have a certain range that they traveled in. \Fref{fig:results2} shows that the change in energy was \qty{-0.01\pm0.02}{\joule}, which is not significantly different from zero.}

\student{One of the limitations on this experiment was how long the track was. If the track was longer than you could push the carts harder and the results would vary. If I were to do this experiment again I would use a longer track and maybe even lighter carts to find different outputs.}

\section{Acknowledgements}
We thank \student{A.~Dekuyper, A.~McMahon}, C.~Payette, J.~Bartholomew, B.~Turner, K.~Mauger, and S.~McCormick for useful advice and comments on the manuscript, and A.~Hahn, S.~Kealy, K~Muttick, and A.~Sankar, for advice on the design of experiment and learning objectives. Major lab equipment was gifted by the Alumni Association at Morristown-Beard School. This work was funded by ONR \#N123456789, AFOSR, NIH, and the National Science Foundation. 
