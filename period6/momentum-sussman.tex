...
\begin{document}
\linenumbers
\title{Is kinetic energy conserved in an elastic collision?}
\author{Charlotte Sussman}
\email{csussman\_25@mbs.net}
...
\begin{abstract}
\student{Kinetic energy is the energy an object has due to motion. Its formula is kinetic energy equals one–half of mass times velocity squared ($KE=\frac{1}{2}mv^2$). It can be useful for us to understand the physics of motion. We examined whether or not kinetic energy is conserved in elastic collision. To do this, we used a system with two carts and one flat, straight track. We discovered that kinetic energy is conserved.}
\end{abstract}
\maketitle
...
\section{Discussion}
\student{In an elastic collision, kinetic energy is conserved. Between periods 4,6, and 8, we collected eighty data sets. Many different people sent Car A toward Car B. The cars could have between 0 and 4 weights on them, and they were sent at different speeds and across different distances. Our data shows that over the eighty collisions, the change in energy was close to 0 ($E=\qty{-0.01\pm0.02}{\joule}$). Although the chance for experimental error is significant, this conclusion makes sense. In our experiment, some of the kinetic energy would have transferred from the first cart to the second cart. The rest would have remained in the first cart, which still moves even after it hits the second cart.}

\student{There are many potential sources of experimental error. Primarily, our sonar range sensors were faulty, as we know from the multiple times they broke down (hence, section 6 had only 21 data sets, meaning it had the fewest). Additionally, there could have been a contact issue between the sensors and the app that made the calculations. We are also extremely limited by the collision size, as it was only about \qty{2}{\meter}. However, I am confident that our calculations were successful.}


\section{Acknowledgements}
We thank \student{K.~Patino, R.~Stulberger, K.~Chen, R.~Karriem,} C.~Payette, J.~Bartholomew, B.~Turner, K.~Mauger, and S.~McCormick for useful advice and comments on the manuscript, and A.~Hahn, S.~Kealy, K~Muttick, and A.~Sankar, for advice on the design of experiment and learning objectives. Major lab equipment was gifted by the Alumni Association at Morristown Beard School. This work was funded by ONR \#N123456789, AFOSR, NIH, and the National Science Foundation. 
