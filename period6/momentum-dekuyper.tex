...
\begin{document}
\linenumbers
\title{The Conservation of Energy Within an Elastic Collision
}
\author{Andrew DeKuyper}
\email{adekuyper\_25@mbs.net}
...
\begin{abstract}
\student{From days of planning, three periods, six classes, eighty sets of data was collected, with each being produced under separate circumstances, ensuring the results were not tainted. The results obtained by our experiment were gathered to answer the question, is energy conserved in an elastic collision? Our results determined that in an elastic collision, energy is conserved. With an average loss so minuscule that it does not affect the consensus that energy is conserved in an elastic collision.}
\end{abstract}
\maketitle
...
\student{We examined the energy conserved in an elastic collision between two karts on a tract. This led us to find that the energy lost was \qty{0.01\pm0.02}{\joule}, which was not a big difference from \qty{0}{\joule}. This is important because they need this information to work and solve other things.}

\section{Discussion}
\student{In an elastic collision collision it is expected that energy will be conserved between the two or more objects. As our experiment, we had multiple objects of varying weight collide along a track. With a collective set of eighty attempts, we obtained an average loss of 0.0131-0.0234 joules or 0.2171\%-0.2955\%. These results lead us to conclude that energy is conserved, as the figure is not significantly different from zero.}

\student{The Morristown-Beard school has many facilities, however, the experiment we performed was greatly limited by its size. This is because unlike schools like Princeton, we do not have laboratories constructed for these specific experiments. This has led to many possible infrequencies in the results due to the surroundings. Our solution to these issues were to have different people to push the objects and performing the experiment on different days. The actual experiment took place on a small track, to ensure an ideal collision. However, this means friction would have affected the two objects.}

\section{Acknowledgements}
We thank \student{R.~Magnotta, A.~Pallone}, C.~Payette, J.~Bartholomew, B.~Turner, K.~Mauger, and S.~McCormick for useful advice and comments on the manuscript, and A.~Hahn, S.~Kealy, K~Muttick, and A.~Sankar, for advice on the design of experiment and learning objectives. Major lab equipment was gifted by the Alumni Association at Morristown-Beard School. This work was funded by ONR \#N123456789, AFOSR, NIH, and the National Science Foundation. 
