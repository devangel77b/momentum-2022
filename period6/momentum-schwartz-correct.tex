...
\begin{document}
\linenumbers
\title{Is energy conserved during an elastic collision}
\author{Jason Schwartz}
\email{jschwartz\_25@mbs.net}
...
\begin{abstract}
\student{Through our trials and tribulations, we have collectively concluded that energy is conserved during an elastic collision; in an ideal frame, theoretically, we would observe a complete transfer of energy between objects, a conversion of the potential energy into kinetic energy occurring leaving the cart to expend its energy due to external forces that would be nonexistent in an ideal frame, as well as extermination its remaining energy into the following cart. The energy lost due to external forces were considered to be insignificant; therefore, the notion that energy would be conserved during an inelastic collision would be applicable and correct.}
\end{abstract}
\maketitle
...
\section{Discussion}
\student{We observed a \qty{0.02}{\joule} on average loss, though not a significant amount; it was on average 20 percent of the energy lost; we believe this was due to external forces such as friction, gravity, air resistance, and other minute forces as subatomic particles. It was within the margin of error, though the 20\% energy loss would be avoided in an ideal plane which would not be possible in our current understanding of the universe. A way to eliminate friction would be to create a perfect track or have the collision take place in a weightless plane. To eliminate air resistance, we would have to replicate the experiment in a vacuum, which can be achieved on earth using a vacuum chamber. Though there is no way to eliminate gravity in the universe, if we are able to recreate the experiment in a free fall, we would be able to replicate the effect.}

\student{Though small, the 20 percent of the energy lost in the collision would still be a significant amount of the total energy; as stated previously, this was due to friction, gravity, and air resistance. If we were to scale up the experiment, we would be able to see whether the scale of the experiential affects the ease of said experiment as well as how it would affect the percentage of energy lost in the experiment; intern the energy loss measured would be significantly greater though as a percentage of the overall energy it may be less. As well as it could be more significant, the ease of the experiment also comes into question; when working with such small values, the margin of error may be smaller than if the experiment was repeated at a grander scale.}

\section{Acknowledgements}
We thank \student{A.~Holbrook}, C.~Payette, J.~Bartholomew, B.~Turner, K.~Mauger, and S.~McCormick for useful advice and comments on the manuscript, and A.~Hahn, S.~Kealy, K~Muttick, and A.~Sankar, for advice on the design of experiment and learning objectives. Major lab equipment was gifted by the Alumni Association at Morristown-Beard School. This work was funded by ONR \#N123456789, AFOSR, NIH, and the National Science Foundation. 
