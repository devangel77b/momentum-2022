...
\section{Discussion}
\student{Energy is conserved because although we did lose some energy, the vast majority was saved. This is clearly evident since the change in energy was \qty{-0.01\pm0.02}{\joule}. We tried our best to make the room for error as small as possible by having different people try the expirement since everyone will have a slightly different result. In addition, we ran the experiment several times to mimimize the expirimental error.}  

\subsection{Error}
\student{There is a possibility to have errors because of certain variables in the experiment. Some situations where there could have been errors were with the sensors, online systems, the people aspect, and other scenarios. As a follow up experiment, we could have multiple collisions and see if we receive the same results as the original experiment.}

\section{Acknowledgements}
We thank \student{A.~Pallone, A.~Upadya, K.~Chen}, C.~Payette, J.~Bartholomew, B.~Turner, K.~Mauger, and S.~McCormick for useful advice and comments on the manuscript, and A.~Hahn, S.~Kealy, K~Muttick, and A.~Sankar, for advice on the design of experiment and learning objectives. Major lab equipment was gifted by the Alumni Association at Morristown-Beard School. This work was funded by ONR \#N123456789, AFOSR, NIH, and the National Science Foundation. 
