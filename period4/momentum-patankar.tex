...
\begin{document}
\linenumbers
\title{Energy, conserved or given?}
\author{Maya Patankar}
\email{mpatankar\_25@mbs.net}
...
\section{Discussion}
\student{During the the we measured the energy loss to be \qty{0.01\pm0.02}{\joule} and the numbers were not much different from zero.}

\student{Examples of this are shown through the table shown. This supports our statement that energy is not lost or gained, but is instead conserve.}

\student{Some limitations that could be considered in this experiment could be human error, or changed circumstances while conducting this ex. we pushed one (or the other) cart(s) at different lengths and/or speeds.}

\student{Something we could do is to measure where we start to push the cart and define the measure of force we used to push the cart(s).}

\section{Acknowledgements}
We thank \student{Jenebah Tyler}, C.~Payette, J.~Bartholomew, B.~Turner, K.~Mauger, and S.~McCormick for useful advice and comments on the manuscript, and A.~Hahn, S.~Kealy, K~Muttick, and A.~Sankar, for advice on the design of experiment and learning objectives. Major lab equipment was gifted by the Alumni Association at Morristown-Beard School. This work was funded by ONR \#N123456789, AFOSR, NIH, and the National Science Foundation. 
