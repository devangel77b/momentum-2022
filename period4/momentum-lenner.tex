...
\author{Rebecca Lenner}
\email{rlenner\_25@mbs.net}
...
\section{Discussion}
\student{The results of this lab show that when two carts hit each other on a track energy is conserved. \qty{0.01\pm0.2}{\joule} of energy was lost. Very little energy was lost which means that energy is conserved in an elastic collision. You can use this equation for many more elastic collisions like when a basketball hits the backboard.}

\section{Acknowledgements}
We thank \student{Lauren and Haven for reading my lab report and sharing their opinions with me}, C.~Payette, J.~Bartholomew, B.~Turner, K.~Mauger, and S.~McCormick for useful advice and comments on the manuscript, and A.~Hahn, S.~Kealy, K~Muttick, and A.~Sankar, for advice on the design of experiment and learning objectives. Major lab equipment was gifted by the Alumni Association at Morristown-Beard School. This work was funded by ONR \#N123456789, AFOSR, NIH, and the National Science Foundation. 
