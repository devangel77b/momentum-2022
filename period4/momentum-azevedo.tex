...
\begin{document}
\linenumbers
\title{Theory of energy}
\author{Gianna Azevedo}
\email{gazevedo\_25@mbs.net}
...
\section{Discussion}
\student{As a result of our testing, using the data we can see energy is being conserved. We can see that the energy after the collision was similar to the energy prior to the collision therefore, there was no change in energy. In \fref{fig:results2}, $\Delta E = \qty{-0.01\pm0.02}{\joule}$, which results in a difference only slightly away from 0. This change was because of an experimental error.}

\student{One experimental error was the velocity because it showed noises in the starting position of the experiment. When we rounded the velocity, the numbers slightly changed. The measurements of velocity are noisy.}

\section{Acknowledgements}
We thank \student{C.~Price}, C.~Payette, J.~Bartholomew, B.~Turner, K.~Mauger, and S.~McCormick for useful advice and comments on the manuscript, and A.~Hahn, S.~Kealy, K~Muttick, and A.~Sankar, for advice on the design of experiment and learning objectives. Major lab equipment was gifted by the Alumni Association at Morristown-Beard School. This work was funded by ONR \#N123456789, AFOSR, NIH, and the National Science Foundation. 
