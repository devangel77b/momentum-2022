...
\section{Discussion}
\student{The results of this lab shows the energy is conserved when 2 carts hit each other on a track. the energy was lost \qty{0.1\pm0.2}{\joule}. These results mean that barely any energy was lost, confirming that energy is conserved in an elastic collision. This can be applied to other elastic collisions like when you spike a ball in volleyball and it bounces off the ground. You can use these equations to find the energy-momentum and velocity before and after a collision in situations you care about. }

\section{Acknowledgements}
We thank \student{Lauren Koepff and Rebecca Lenner for helping to proofread}, C.~Payette, J.~Bartholomew, B.~Turner, K.~Mauger, and S.~McCormick for useful advice and comments on the manuscript, and A.~Hahn, S.~Kealy, K~Muttick, and A.~Sankar, for advice on the design of experiment and learning objectives. Major lab equipment was gifted by the Alumni Association at Morristown-Beard School. This work was funded by ONR \#N123456789, AFOSR, NIH, and the National Science Foundation. 
