...
\author{Jake Ben-Hayon}
\email{jbenhayon\_25@mbs.net}
...
\section{Discussion}
\student{The results of the lab show that energy is conserved when 2 carts hit each other on a
track. The energy lost was \qty{0.1\pm0.2}{\joule}. These results mean that barely any energy was lost confirming that energy is conserved in an elastic collision. This can be applied to other elastic collisions. For example, when a football hits a wide receiver's hands and bounces off. You can use these equations to find the energy momentum and velocity before and after a collision.}

\section{Acknowledgements}
We thank \student{Liam Atkins, and Nick Troiano}, C.~Payette, J.~Bartholomew, B.~Turner, K.~Mauger, and S.~McCormick for useful advice and comments on the manuscript, and A.~Hahn, S.~Kealy, K~Muttick, and A.~Sankar, for advice on the design of experiment and learning objectives. Major lab equipment was gifted by the Alumni Association at Morristown-Beard School. This work was funded by ONR \#N123456789, AFOSR, NIH, and the National Science Foundation. 
