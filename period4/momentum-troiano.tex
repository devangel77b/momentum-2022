...
\section{Discussion}
\student{Energy was not conserved because it was not all transferred to the momentum of the second cart. The cart produced friction (while minimal) as it rode along the track, and the magnets did not allow for a complete transfer of energy. Cart number one consistently moved backwards after collision, and since a perfectly elastic collision would leave cart 1 motionless, energy is not conserved. Or it is rather, just not transferred.}
