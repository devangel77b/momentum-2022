...
\author{Jenebah Tyler}
\email{jtyler\_25@mbs.net}
...
\section{Discussion}
\student{We measured the energy loss to be \qty{0.01\pm0.02}{\joule} and most numbers weren't significantly different from 0. One example of this is \fref{fig:results2}, which measures $E_f$, or final energy, as 0.02085949779.}

\student{It does not support the idea that energy is lost or gained and supports our ideas.}

\student{Energy is conserved because over 90 trials, the energy was relatively the same throughout each trial, disregarding the air pressure, friction, and other minor factors that could have led to experimental error.}

\section{Acknowledgements}
We thank \student{Maya Patankar}, C.~Payette, J.~Bartholomew, B.~Turner, K.~Mauger, and S.~McCormick for useful advice and comments on the manuscript, and A.~Hahn, S.~Kealy, K~Muttick, and A.~Sankar, for advice on the design of experiment and learning objectives. Major lab equipment was gifted by the Alumni Association at Morristown-Beard School. This work was funded by ONR \#N123456789, AFOSR, NIH, and the National Science Foundation. 
