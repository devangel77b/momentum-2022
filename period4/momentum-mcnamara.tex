...
\begin{document}
\linenumbers
\title{Energy is conserved during elastic collisions}
\author{Olivia Mellon McNamara}
\email{omcnamara\_25@mbs.net}
...
\section{Discussion}
\student{During an elastic collision, energy is conserved. There were 80 trials over all classes. We concluded that the change is $\Delta E = \qty{-0.01\pm0.02}{\joule}$, because the sum is so close to zero, we can assume that energy is conserved. This can be applied to similar elastic collisions.}

\student{When thinking about how to eliminate all outside factors that may interfere with our collision, we decided we should do multiple trials so that elements that would interfere with our results would be eliminated. The way we eliminated air density, as it can disrupt ultrasonic units, is we did trials on different days. We divided the average by energy over the initial energy to show we lost 20\% of energy which was lost by the coefficient of restitution, but it is very difficult to do this collision perfectly. This loss of energy could have also been caused by friction, air resistance, or gravity.}

\section{Acknowledgements}
We thank \student{I.~Johnston}, C.~Payette, J.~Bartholomew, B.~Turner, K.~Mauger, and S.~McCormick for useful advice and comments on the manuscript, and A.~Hahn, S.~Kealy, K~Muttick, and A.~Sankar, for advice on the design of experiment and learning objectives. Major lab equipment was gifted by the Alumni Association at Morristown-Beard School. This work was funded by ONR \#N123456789, AFOSR, NIH, and the National Science Foundation. 
