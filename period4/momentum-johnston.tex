...
\begin{document}
\linenumbers
\title{Energy is conserved in an elastic collision}
\author{Isla Johnston}
\email{ijohnston\_25@mbs.net}
...
\section{Discussion}
\student{Energy is conserved. After attempting 80 trails, the average was close to 0 (\qty{-0.01\pm0.02}{\joule}). This is important because we can apply these energy conservation methods to similar elastic collisions.}

\student{By doing multiple trials and trying different experiments with the carts, cancels out anything unique. When it came to the weights, we would put them in different amounts and places on the cart. In order to conserve the air density we would do a couple trials each day in case the air density was low one day and then high the other.}

\student{We noticed that we were losing up to 20\% of restitution. This means for our next experiment in order to focus on measuring the coefficient of restitution, we have to do multiple of the exact same trials.}

\section{Acknowledgements}
We thank \student{O.~McNamara}, C.~Payette, J.~Bartholomew, B.~Turner, K.~Mauger, and S.~McCormick for useful advice and comments on the manuscript, and A.~Hahn, S.~Kealy, K~Muttick, and A.~Sankar, for advice on the design of experiment and learning objectives. Major lab equipment was gifted by the Alumni Association at Morristown-Beard School. This work was funded by ONR \#N123456789, AFOSR, NIH, and the National Science Foundation. 
