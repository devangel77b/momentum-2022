...
\begin{document}
\linenumbers
\title{Carly Greer has no title}
\author{Charlotte Greer}
\email{cgreer\_25@mbs.net}
...
\section{Discussion}
\student{The mean of the original data shows that an average of \qty{0.009}{\joule} of energy to be lost due to the collision. However, this value is subtracted by the standard deviation which tells you how spread out the measurements are, allowing you to account for experimental error. As a result, the energy is measured to be \qty{-0.01\pm0.02}{\joule}, which is not significantly different from zero. This rules out the loss or gain of energy due to collision, and the significance value holds a high probability that the change of energy will be zero, proving that energy is conserved throughout an elastic collision.} 

\student{In contrast, scaling can be used to argue that energy is not conserved. While $\Delta E$ seems small, $E_0$ is as well, meaning it is a large percentage of the initial energy (about 30\%). Losing 30\% of energy is not a small amount, thus it can be argued that energy is non conserved. If I were to test this, I would conduct an experiment in which multiple collisions occurred consecutively. Analyzing this data would allow you to see how much energy was lost after each collision.} 
