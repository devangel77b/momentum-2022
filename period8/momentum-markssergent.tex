...
\email{lmarkssergent\_25@mbs.net}
...
\section{Discussion}
\student{We concluded that energy is conserved. The change in energy through the 81 collisions conducted was always +0.01 or -0.01. $E_0 = \frac{1}{2} m_1 v_{1,0}^2$ is the original energy of the start of the collision. The end of the collision, when $m_1$ meets $m_2$, it should have stopped moving, meaning a decrease in momentum. The equation would be $E_f = \frac{1}{2} m_1 v_{1,f}^2 + \frac{1}{2} m_2 v_{2,f}^2$. 
The two equations are not equal, so some energy was lost, but the change was only 0.01 each time. The energy is conserved, as the change was actually very close to 0.}

\student{There wasn’t very much in terms of experimental errors in the lab, because we were very thorough with 81 collisions that all yielded about the same results.}
