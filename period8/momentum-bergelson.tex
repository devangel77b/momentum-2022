...
\author{Eric Bergelson}
\email{ebergelson\_25@mbs.net}
...
\section{Discussion}
\student{Energy is conserved through elastic collisions since the momentum is transferred to the object that is getting hit. The object that gets hit gets roughly 70-80 percent momentum while the rest gets put out into energy (heat.) The energy that turns into best quickly disperses.}
