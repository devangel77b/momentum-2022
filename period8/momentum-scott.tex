...
\begin{abstract}
Momentum is the product of mass times velocity ($\vec{p}=m\vec{v}$), and kinetic energy of a moving mass is given by $\frac{1}{2}mv^2$. Both are potentially useful for understanding the mechanics of collisions, but while previous studies have examined momentum conservation during inelastic collisions \cite{ortega-2021-momentum}, they have not considered energy conservation during elastic collisions. \student{Using two karts on a track, we measured the energy conserved in an elastic collision. As a result, we determined that the energy lost was \qty{0.01\pm0.2}{\joule}, a difference that was not significant. Knowing this is crucial because they need more information to continue solving problems.}\end{abstract}
\maketitle
...
\section{Discussion}
\student{Throughout this lab, it was discovered that two carts hitting each other on the track conserve energy. There was a loss of \qty{0.1\pm0.2}{\joule}. It is evident from these results that hardly any energy was lost in an elastic collision, confirming its conservation. The same concept can be applied to hitting the goal post on a shot during another elastic collision in lacrosse. In situations that concern you, these equations may be used to calculate energy-momentum and velocity before and after a collision. }
