...
\begin{document}
\linenumbers
\title{Gabi Biamonte has no title}
\author{Gabriella Biamonte}
\email{gbiamonte\_25@mbs.net}
...
\section{Discussion}
\student{Energy is conserved, that means in our experiment the change in energy is not significantly different from zero. We got results that were near -0.02 and this indicates that energy is not gained but still could be lost. However, something that affected the lab was that we did the experiment in the classroom so we had a limit of what we could do.}
