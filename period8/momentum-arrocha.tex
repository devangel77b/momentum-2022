...
\section{Discussion}
\student{Energy is conserved. The Law of Conservation of Energy states that "energy can neither be destroyed nor created but it may change forms depending on its happening." In the case of the collisions between the two cars the energy was transferred on impact but 20\% of the energy disappeared. To go back to the quote, the energy can't be destroyed but it can change. So where did the energy go? Well, the energy turned into heat. On impact, the stress caused by the collision causes the energy to turn into heat rather than transfer into transferred momentum. Therefore, energy is conserved but some of the energy turns into heat.}
