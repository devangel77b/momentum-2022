...
\begin{document}
\linenumbers
\title{Does energy transfer}
\author{Will L'estrange}
\email{wlestrange\_25@mbs.net}
...
\begin{abstract}
Momentum is the product of mass times velocity ($\vec{p}=m\vec{v}$), and kinetic energy of a moving mass is given by $\frac{1}{2}mv^2$. Both are potentially useful for understanding the mechanics of collisions, but while previous studies have examined momentum conservation during inelastic collisions \cite{ortega-2021-momentum}, they have not considered energy conservation during elastic collisions. \student{When the two trains collided some energy was disposed of in air but most of the energy disposed in the other train propelling it back at a speed close to the first train. We learned that almost all the energy gets transferred while most of it gets transferred. We also found that the energy that does not get transferred transfers in air resistance and heat when colliding. }
\end{abstract}
\maketitle
...
\section{Discussion}
\student{Based on our data we can see that energy is conserved and then transferred once the collision happens, not including the small energy that gets lost in heat and air resistance.}
