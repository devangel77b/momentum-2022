...
\begin{document}
\linenumbers
\title{Energy is conserved}
\author{Nathan Soos}
\email{nsoos\_25@mbs.net}
...
\section{Discussion}
\student{Energy is conserved. From the data set above me we averaged the numbers under K and J. The average numbers were 0.0234 and 0.2955 these numbers are showing how little the energy changed during the collision. However they are not both 0. This is because when the magnets collide transferring the energy there is little heat that is generated automatically causing it to lose energy. However the numbers are so similar that it accounts to energy being conserved.}
