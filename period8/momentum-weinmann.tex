...
\begin{document}
\linenumbers
\title{Indiya Weinmann has no title}
\author{Indiya Weinmann}
\email{iweinmann\_25@mbs.net}
...
\section{Discussion}
\student{We found that there is a slight change from zero for the energy usage (+-0.02 and +-0.01), but not significant enough to truly affect the energy conservation. Energy is definitely not gained, but only very slightly lost, that does not change the outcome of inelastic collisions. On the other hand, when you compute (+-0.01 and +-0.02) into a fraction form of the energy lost from the initial energy, there is a 20\% change that is apart of the experiment. I think the percentage goes into the experimental error which plays into the large number in percentage change in energy.}

\student{In our discussion, we found that energy is more or less conserved in an elastic collision. In an experiment, it is tough to have a perfectly elastic collision which can come with some minor mistakes. By using our formula: $\Delta E/E_0$, or the change in energy divided by our initial energy, we see a significant change in the use of our energy. There is a 20\% change in the energy usage, but with the experimental error it evens out back to zero. }

\section{Acknowledgements}
We thank \student{FILL IN}, C.~Payette, J.~Bartholomew, B.~Turner, K.~Mauger, and S.~McCormick for useful advice and comments on the manuscript, and A.~Hahn, S.~Kealy, K~Muttick, and A.~Sankar, for advice on the design of experiment and learning objectives. Major lab equipment was gifted by the Alumni Association at Morristown Beard School. This work was funded by ONR \#N123456789, AFOSR, NIH, and the National Science Foundation. 
