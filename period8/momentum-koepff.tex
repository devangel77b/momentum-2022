...
\begin{document}
\linenumbers
\title{Energy is conserved in an elastic collisions}
\author{Lauren Koepff}
\email{lkoepff\_25@mbs.net}
...
\begin{abstract}
Momentum is the product of mass times velocity ($\vec{p}=m\vec{v}$), and kinetic energy of a moving mass is given by $\frac{1}{2}mv^2$. Both are potentially useful for understanding the mechanics of collisions, but while previous studies have examined momentum conservation during inelastic collisions \cite{ortega-2021-momentum}, they have not considered energy conservation during elastic collisions. We examined \student{the energy conserved in an elastic collision between carts on a track}. \student{Then we found that the energy lost was \qty{0.01\pm0.02}{\joule} meaning barley any energy was lost affirming our hypothesis.}\end{abstract}
\maketitle
...
\section{Discussion}
\student{The results of this lab show that energy is conserved whe two carts hit each other on a track. The energy lost was \qty{0.1\pm0.2}{\joule}. These results mean that barely any energy was lost, confirming that energy is conserved in an elastic collision. This can be applied to other elastic collisions in lacrosse when you hit the goal post on a shot. You can use these equations to find the energy-momentum and velocity before and after a collision in situations you care about.}

\section{Acknowledgements}
We thank \student{N.~Troiano for helping to proofread}, C.~Payette, J.~Bartholomew, B.~Turner, K.~Mauger, and S.~McCormick for useful advice and comments on the manuscript, and A.~Hahn, S.~Kealy, K~Muttick, and A.~Sankar, for advice on the design of experiment and learning objectives. Major lab equipment was gifted by the Alumni Association at Morristown-Beard School. This work was funded by ONR \#N123456789, AFOSR, NIH, and the National Science Foundation. 
